...
def op():
	subprocess.call("tshark -r output -T fields -e frame.time_epoch -e eth.src -e tcp.srcport -e tcp.dstport -E header=y -E separator=, -E quote=d -E occurrence=f > output.csv", shell=True)
